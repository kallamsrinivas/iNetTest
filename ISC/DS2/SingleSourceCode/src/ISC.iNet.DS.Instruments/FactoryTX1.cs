...
{
	public class FactoryTX1 : TX1, IFactoryController
	{
		#region Constructors

		/// <summary>
		/// Instrument controller class for TX1 instruments with access to factory methods.
		/// </summary>
		public FactoryTX1()
			: base( new Tx1FactoryDriver() )
		{
		...
		/// </summary>
		private Tx1FactoryDriver FactoryDriver
		{
			get
			{
				return (Tx1FactoryDriver)this.Driver;
			}
		}
